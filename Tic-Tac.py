...
player1_name = Entry(tk, textvariable=p1, bd=5).grid(row=1, column=1, columnspan=8)
player2_name = Entry(tk, textvariable=p2, bd=5).grid(row=2, column=1, columnspan=8)
...
L1 = Label( tk, text="Player 1:", font='Times 20 bold', bg='white', fg='black', height=1, width=8).grid(row=1, column=0)

L2 = Label( tk, text="Player 2:", font='Times 20 bold', bg='white', fg='black', height=1, width=8).grid(row=2, column=0)
